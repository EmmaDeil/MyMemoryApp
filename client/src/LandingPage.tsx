   ...
   return (
      <div className='' style={{marginBottom: '50px'}}>
         ...
         <div className='' style={{ textAlign: 'center', marginTop: '30px', justifyContent: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <img src="/camera.svg" alt="cameraImage" style={{borderRadius: '50px', width: '100px', height: '100px', border: '1px solid #ccc', padding: '20px', background: 'linear-gradient(to right, red, orange, yellow, green, blue, indigo, violet)', WebkitBackgroundClip: 'text', color: 'transparent'}} className='camera-image'/>
